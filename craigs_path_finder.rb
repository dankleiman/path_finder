require 'pry'
# def recursive_search(value, element, current_path, paths = [])
#   if path_finder(value, element, current_path) != nil
#     paths << path_finder(value, element, current_path)
#   end
#   paths
# end
...
# data = {key: [1, 2, "value", {key2: {key3: [2, "value"]}}]}

raw_path = path_finder('Maleficent', data)
puts raw_path.inspect
puts
puts
raw_path.each do |path|
  puts path
end
